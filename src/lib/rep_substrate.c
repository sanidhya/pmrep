...
static inline void free_read_lists(pmrep_ctx_t *pctx, uint64_t id, int thread_id)
{
...
static void update_wr_info(pmrep_ctx_t *pctx)
{
...
static void allocate_structures(pmrep_ctx_t *pctx, uint8_t *buffer, size_t size,
...
static inline void receive_mr_data(pmrep_ctx_t *pctx)
{
    struct ibv_wc wc = {};
...
static inline void send_mr_data(pmrep_ctx_t *pctx)
{
